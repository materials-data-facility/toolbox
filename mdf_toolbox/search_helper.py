...
def _validate_query(query):
    ...
    # limit should be set if not specified
...
class SearchHelper:
    """Utility class for performing queries using a Globus SearchClient
    ...
    def __init__(self, index, search_client):
    ...
    def initialized(self):
        """Whether any term has been added to the query."""
        return not self.__query["q"] == BLANK_QUERY["q"]
